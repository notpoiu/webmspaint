      ...
      <div className="flex flex-col items-center justify-center px-2 text-center">
          ...
          <h1 className="text-3xl font-bold text-center flex flex-col">
            <span>
              ...
              <span className="font-bold">
                over <NumberTicker value={guildData.approximate_member_count} />
                + people
              </span>
            </span>
        ...
        >
          <AccordionItem value="item-1">
            <AccordionTrigger>
              How do I get whitelisted? How do I get a free key?
            </AccordionTrigger>
            <AccordionContent>
              Tutorial on how to use the Key System is here:{" "}
              <Link
                href={"https://docs.upio.dev/mspaint/key-system"}
                target="_blank"
                className="text-blue-300 underline"
              >
                https://docs.upio.dev/mspaint/key-system
              </Link>
              .
            </AccordionContent>
          </AccordionItem>
